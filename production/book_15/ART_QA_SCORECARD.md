# Book 15 — Horses — Art QA Scorecard
...
- [ ] Horse anatomy is structurally correct: head, neck, barrel, back, legs, joints, hooves, mane, and tail
- [ ] Pony, draft, warmblood, gaited, miniature, and light-horse body types stay visibly distinct
- [ ] Breed-specific ears, feathering, coat patterns, mane style, and proportions are preserved where relevant
- [ ] Legs and hooves are complete, weight-bearing, and free of impossible joints or duplicated limbs
