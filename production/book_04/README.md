# Book 4 — Jungle Animals Coloring Book for Kids Ages 4-8

Production packet for MIST° Animal Coloring Adventures.

## Locked metadata
- Subtitle: 60 Bold & Easy Jungle Creatures with Fun Facts
- Author: Paul Thach
- Imprint: MIST°
...
## Source files
- `catalog/books/book_04/animals.csv`
- `catalog/books/book_04/page_map.csv`
- `build/configs/book_04.json`
- `kdp/book_04.txt`

## Artwork
- Batch B007: subjects 01-30
- Batch B008: subjects 31-60
- Approved art root: `production/artwork-workspace/book_04/`
...
- [ ] paperback and hardcover 128-page interiors built
- [ ] paperback cover built from final 128-page geometry
- [ ] hardcover cover built from exact current KDP template
- [ ] KDP Previewer passes
- [ ] physical proof reviewed
- [ ] Kindle title record -> Paperback -> Hardcover
