# Book 5 — Safari Animals Coloring Book for Kids Ages 4-8

Production packet for MIST° Animal Coloring Adventures.

## Locked metadata
- Subtitle: 60 Bold & Easy Wild Animals with Fun Facts
- Author: Paul Thach
- Imprint: MIST°
...
## Source files
- `catalog/books/book_05/animals.csv`
- `catalog/books/book_05/page_map.csv`
- `build/configs/book_05.json`
- `kdp/book_05.txt`

## Artwork
- Batch B009: subjects 01-30
- Batch B010: subjects 31-60
- Approved art root: `production/artwork-workspace/book_05/`
