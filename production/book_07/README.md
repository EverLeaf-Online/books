# Book 7 — Arctic Animals Coloring Book for Kids Ages 4-8

Production packet for MIST° Animal Coloring Adventures.

## Locked metadata
- Subtitle: 60 Bold & Easy Polar Creatures with Fun Facts
- Author: Paul Thach
- Imprint: MIST°
...
## Source files
- `catalog/books/book_07/animals.csv`
- `catalog/books/book_07/page_map.csv`
- `build/configs/book_07.json`
- `kdp/book_07.txt`

## Artwork
- Batch B013: subjects 01-30
- Batch B014: subjects 31-60
- Approved art root: `production/artwork-workspace/book_07/`
